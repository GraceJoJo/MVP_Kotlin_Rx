...
public class RetrofitManager {
    ...
    private final String BASE_URL = "https://www.sojson.com/open/api/";
...
//                          .addNetworkInterceptor(new CacheInterceptor())//必须要有，否则会返回504
    ...
    public class CacheInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            Request request = chain.request();
            if (!NetUtils.isNetworkConnected(MyApplication.Companion.getContext())) {
...
//    }
    ...
    public void doNormalRequest() {
        getRequestService().getWeather("北京")
