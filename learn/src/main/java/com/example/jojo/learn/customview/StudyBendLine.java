...
public class StudyBendLine extends View {
    ...
    private void initPaint() {
        //画线的画笔
        linePaint = new Paint();
        linePaint.setColor(Color.parseColor("#e05864"));
        ...
        mPaint.setColor(Color.parseColor("#e05864"));
    ...
    private void drawArea(Canvas canvas, List<PointF> Points) {
        LinearGradient mShader = new LinearGradient(0, 0, 0, getMeasuredHeight(), new int[]{Color.parseColor("#e05864"), Color.parseColor("#f898a0"), Color.parseColor("#fffdfd")}, new float[]{0.0f, 0.65f, 1f}, Shader.TileMode.REPEAT);
...
//        作者：隔壁小王66
//        来源：CSDN
//        原文：https://blog.csdn.net/qq_16131393/article/details/89671919
