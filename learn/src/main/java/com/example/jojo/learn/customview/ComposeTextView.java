...
public class ComposeTextView extends View {
    ...
    public ComposeTextView(Context context, AttributeSet attrs) {
        ...
        textSize = a.getDimensionPixelSize(R.styleable.ComposeTextView_ComposetextSize, textSize);
        textColor = a.getColor(R.styleable.ComposeTextView_ComposetextColor, textColor);
