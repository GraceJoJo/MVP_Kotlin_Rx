...
//        if(isAnimation) {
//            mPaint.setColor(Color.RED);
//            canvas.drawArc(rectF, startAngle, mChangeAngle, true, mPaint);
//        }
...
//        Log.e("coords:", "x轴:" + coords[0] + " -- y轴:" + coords[1]);
    ...
    public void updateDate(List<Float> rateList, List<Integer> colorList, boolean isShowRateText) {
        ...
        ValueAnimator valueAnimator = ObjectAnimator.ofFloat(0, 360f);
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                mChangeAngle = currentAngle;
                Log.e("TAG", "mChangeAngle=" + mChangeAngle);
                isAnimation = true;
                postInvalidate();
            }
        });
